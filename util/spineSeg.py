...
def ThreeDBand(body_seg, breathing_seg, BB_index, CC_index):
    ...
    confined_region = body_seg - convex_hull_seg
...
def SpineROI(Aorta_segmentation, CT_scan):
    ...
    Aorta_seg_data = Aorta_segmentation
...
def create_ROI_img(cur_ct, aorta_img):
    """
    ...
    print("Isolating the Body Contour")
    body_seg = IsolateBody(cur_ct)
    print("Finding the Coordinations for Body")
